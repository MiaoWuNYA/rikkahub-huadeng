...
### 安卓上的 **AI 聊天客户端**，兼为 **SillyTavern（酒馆）兼容端**
...
>
> - **只想找个好用的 AI 聊天 App**：接上任意 API 就能聊——多供应商、流式输出、语音通话、插件工具、记忆系统、缓存省钱，装上就用，不需要懂任何"酒馆"概念
> - **从桌面端酒馆 migrating**：角色卡、世界书、预设、正则、美化主题按官方语义无损导入，无需 Termux 或 Node.js
>
> 两条路线共用同一个客户端，互不干扰。
